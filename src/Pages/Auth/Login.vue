      ...
      <div class="inner-box">
        <div class="forms-wrap">
          <form autocomplete="off" class="sign-in-form" @submit.prevent="login()">
            <div class="logo">
              <img src="@/assets/images/logos/fav.png" class="w-v_65px" alt="easyclass" />
            </div>
            <div class="heading">
              <h2>Welcome Back</h2>
              <h6>Stablish your company?</h6>
              <router-link :to="{ name: 'CompanyInfo' }" class="text-v_12 text-gray-500" >
                Register now
              </router-link>
            </div>
            ...
            <div class="actual-form">
              <div class="input-wrap">
                <input type="email" minlength="4" class="input-field" autocomplete="off" placeholder="Awesome Email" v-model="payload.email" />
                <p class="mb-1 error_email error"></p>
              </div>

              <div class="input-wrap">
                <input type="password" minlength="4" class="input-field mt-2" autocomplete="off" placeholder="Awesome Password" v-model="payload.password"/>
                <p class="mb-1 error_password error"></p>
              </div>

              <LoaderButton :loading="signInLoader" class="w-full my-6">
                <template #text>
                  Sign In
                </template>
              </LoaderButton>
              ...
              <p class="text">
                ...
                <router-link :to="{ name: 'CompanyInfo' }">Reset your password</router-link>
              </p>
            </div>
          </form>
        </div>
        ...
        <div class="carousel">
          <div class="images-wrapper">
            <img src="@assets/images/auth/image1.png" class="image img-1 show" alt=""/>
            <img src="@assets/images/auth/image2.png" class="image img-2" alt=""/>
            <img src="@assets/images/auth/image3.png" class="image img-3" alt="" />
          </div>
          ...
          <div class="text-slider">
            <div class="text-wrap">
              <div class="text-group">
                ...
                <h2>Invite employees to your workspace</h2>
              </div>
            </div>
